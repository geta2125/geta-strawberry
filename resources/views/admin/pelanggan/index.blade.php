                            ...
                            <tbody>
                                @foreach ($dataPelanggan as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->phone }}</td>
                                        <td>
                                            {{-- Container Flexbox agar tombol sejajar rapi --}}
                                            <div class="d-flex gap-1">

                                                {{-- TOMBOL DETAIL (Opsional: Saya buat warna Teal/Info agar beda) --}}
                                                <a href="{{ route('pelanggan.show', $item->pelanggan_id) }}" class="btn btn-info btn-sm text-white">
                                                    <i class="fas fa-eye me-1"></i>Detail
                                                </a>

                                                {{-- TOMBOL EDIT (Warna Biru seperti di Screenshot) --}}
                                                <a href="{{ route('pelanggan.edit', $item->pelanggan_id) }}" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-edit me-1"></i>Edit
                                                </a>

                                                {{-- TOMBOL HAPUS (Warna Merah seperti di Screenshot) --}}
