                ...
                <a href="<?php echo e(route('user.index')); ?>" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" data-slot="icon" fill="none" stroke-width="1.5"
                            ...
                            aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15.75 7.5a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.5 20.25a8.25 8.25 0 1 1 15 0h-15Z">
                            </path>
                        </svg>
                    </span>
...
<?php /**PATH D:\2SIA_Geta_framework\laragon-6.0-minimal\laragon-6.0-minimal\www\geta-strawberry\resources\views/layouts/admin/sidebar.blade.php ENDPATH**/ ?>