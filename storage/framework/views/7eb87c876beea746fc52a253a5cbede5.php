<?php $__env->startSection('content'); ?>
    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
        ...
        <form action="<?php echo e(route('auth.login')); ?>" method="POST" class="mt-4">
        <?php echo csrf_field(); ?>
            <!-- Form -->
...
<?php echo $__env->make('layouts.auth.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\2SIA_Geta_framework\laragon-6.0-minimal\laragon-6.0-minimal\www\geta-strawberry\resources\views/auth/login.blade.php ENDPATH**/ ?>