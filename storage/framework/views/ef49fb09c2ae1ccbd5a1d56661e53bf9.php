...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/css/custom-style.css')); ?>">
    <style>
        body {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
           <img src="<?php echo e(asset('asset/images/logo.jpg')); ?>"alt="Logo">
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="font-bianca">Contoh font custom</h1>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-group mb-3">
                            <?php $__currentLoopData = $list_pendidikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\2SIA_Geta_framework\laragon-6.0-minimal\laragon-6.0-minimal\www\geta-strawberry\resources\views/home.blade.php ENDPATH**/ ?>